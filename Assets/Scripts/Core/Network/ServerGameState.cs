...
namespace MahjongGame.Core.Network
{
    ...
    public class ServerGameState
    {
            ...
            switch (type)
            {
                ...
                case ClientActionType.Pon:
                    ...
                    snapshot.Melds.Add(new Meld(MeldType.Pon,
                        new List<TileData> { targetTile, targetTile, targetTile },
                ...
                case ClientActionType.MingGan:
                    ...
                    snapshot.Melds.Add(new Meld(MeldType.Kan_Exposed,
                        new List<TileData> { targetTile, targetTile, targetTile, targetTile },
                        targetTile.OriginalOwnerID));
                    break;
        ...
        public List<TileData> GetHand(int playerId) => new List<TileData>(_players[playerId].Hand);
        public List<Meld> GetMelds(int playerId) => new List<Meld>(_players[playerId].Melds);
